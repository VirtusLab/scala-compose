...
object Build {
  ...
  private def build(
  ...
  ): Either[BuildException, Map[String, Seq[Builds]]] = either {
    ...
    def doBuild(
      ...
      val mainSources0 = scopedSources.sources(Scope.Main, baseOptions orElse mainDeps)
      val testSources0 = scopedSources.sources(Scope.Test, baseOptions orElse testDeps)
  ...
  def build0(
    ...
    actionableDiagnostics: Option[Boolean],
    configDir: Option[os.Path]
  ): Either[BuildException, Map[String, Seq[Builds]]] = {
